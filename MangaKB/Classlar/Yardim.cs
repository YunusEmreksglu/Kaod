...
namespace MangaKB.Classlar
{
    ...
    {
        public static List<Button> Kenar(Rectangle rect, Tag tag, Panel panel)
        {
            ...
            ListButton.Add(new Cerceve() { Buttons = buttons, id = ButtonIndexT, tag = tag });
            ButtonIndexT++;

            return buttons;
        }

        public static void KenarlarLoad()
        {
            foreach (Cerceve bu in ListButton)
            {
                if (!(bu.id == 4444))
                {
                    pens(bu.Buttons, Resim, bu.tag.Color);
                }
        ...
        public static void KenarLoad(Cerceve cerceve, Image image, Color color)
        {
            pen(cerceve.Buttons, image, color);
        }
        ...
        public static void ResimYukle()
        {
            ...
            Bitmap mainBitmap = new Bitmap(ResimBox.Width, ResimBox.Height);
        ...
        public static void ResimSil(int Sil, Panel panel)
        {
        ...
        public static void ResimKesinSil()
        {
            Kutular = Kutular.Where(item => item.Tag != "4444").ToList();
            ListButton = ListButton.Where(item => item.id != 4444).ToList();
        }

        public static void ResimleriSil(Panel panel)
        {
            Kutular.Clear();
            ButtonIndexT = 0;
            ListButton.Clear();
        ...
        public static void FormMouseMove(object sender, MouseEventArgs e)
        {
            ...
            if (_isDragging)
            {
                ...
                KenarLoad(ListButton[cerceveId], Resim, ListButton[cerceveId].tag.Color);
        ...
        public static List<Kutu> Kutular = new List<Kutu>();
        public static List<Cerceve> ListButton = new List<Cerceve>();
        public static Tag tag = new Tag();
        public static Bitmap Resim = new Bitmap(512, 728);
