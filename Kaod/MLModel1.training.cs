...
namespace MangaKB
{
    ...
    {
        public const string RetrainFilePath = @"C:\Users\asus\source\repos\MangaKB\MangaKB\MangaDataS\vott-json-export\Test-export.Json";
        public const int TrainingImageWidth = 517;
        ...
        private static IEnumerable<ModelInput> LoadFromVott(string inputDataFilePath)
        {
            ...
            {
                if (File.Exists(asset.Value["asset"]["path"].GetValue<string>().Replace("file:", "")))
                {
