...
namespace MangaKB.Classlar
{
    public class JsonMain
    {
        ...
        public void LocationCreate(string isim, string NewLocation)
        {
            ...
            VoTTClass.Create(isim, NewLocation);
        ...
        public void Save(List<Box> Boxs, int ImageWidth, int ImageHeight, FileInfo ImagePaht, Image Image)
        {
            AssetJson.AssetData AssetData = AssetJsonClass.Save(Boxs, ImageWidth, ImageHeight, ImagePaht, Image);
        ...
        {
            VoTTClass.TagAdd(Name, Renk);
        }

        public void TagRemove(int i)
        {
            VoTTClass.TagRemove(i);
        }

        public List<AssetJson.AssetData> Images()
        {
            return AssetJsonClass.Images();
        }
        ...
        {
            if (File.Exists(Location + "vott-json-export\\" + Name + "-export.json"))  return ExportClass.Assets();
            else return null;
        }
